...
export class DataService<Type> {
    ...
    public transaction(ns: 'ServiceReceived', asset: Type): Observable<Type> {
        console.log('Entered DataService add');
        console.log('Add ' + ns);
        console.log('asset', asset);

        console.log('this.extractData ', asset)

        return this.http.post(this.actionUrl + ns, 
            {
                "$class": "org.acme.delivery.legalcontract.ServiceReceived",
                "delivery": asset
            }
        )
          .map(this.extractData)
    ...
    private extractPostData(res: Response): any {
        console.log('extractPostData ', res.ok)
